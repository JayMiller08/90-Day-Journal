  ...
  const renderLogin = () => (
    <div className="animate-fade-in space-y-6">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button type="submit" disabled={isLoading} className="w-full py-4 bg-stone-900 text-white rounded-xl font-medium hover:bg-stone-800 transition-colors mt-4">
  ...
  const renderStep0 = () => (
    <div className="animate-fade-in text-center space-y-8">
      ...
      <div className="space-y-4 pt-8">
        ...
        <button onClick={() => setStep(-1)} className="w-full py-4 bg-white text-stone-900 border border-stone-200 rounded-xl font-medium text-lg hover:bg-stone-50 transition-colors">
          Login
        </button>
      </div>
    </div>
